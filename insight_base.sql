...
(replace(uuid(), '-', ''), 'cdf0ffb178b741b287d1f155d0165112', 1, 6, '解封', 'releaseUser', json_object("method", "enable", "iconUrl", "icons/enable.png", "beginGroup", true, "hideText", false), '系统', '00000000000000000000000000000000', now()),
