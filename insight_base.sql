...
(replace(uuid(), '-', ''), '编辑接口配置', 'PUT', '/base/auth/manage/v1.0/configs', 'editConfig', 10, NULL, NULL, NULL, 1, 1, now()),
(replace(uuid(), '-', ''), '删除接口配置', 'DELETE', '/base/auth/manage/v1.0/configs', 'deleteConfig', 10, NULL, NULL, NULL, 1, 1, now()),
