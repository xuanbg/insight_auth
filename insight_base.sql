...
('711aad8daf654bcdb3a126d70191c15c', '8c95d6e097f340d6a8d93a3b5631ba39', '9dd99dd9e6df467a8207d05ea5581125', 2, 1, '租户管理', json_object("module", 'Tenants', "file", 'Platform.dll', "autoLoad", true, "iconUrl", "icons/tenant.png"), '系统', '00000000000000000000000000000000', now()),
('c02bbc8cfc4f11e99bc30242ac110005', '8c95d6e097f340d6a8d93a3b5631ba39', '9dd99dd9e6df467a8207d05ea5581125', 2, 2, '平台用户', json_object("module", 'Users', "file", 'Platform.dll', "autoLoad", false, "iconUrl", "icons/user.png"), '系统', '00000000000000000000000000000000', now()),
('aac02362df4611e9b5650242ac110002', '8c95d6e097f340d6a8d93a3b5631ba39', '9dd99dd9e6df467a8207d05ea5581125', 2, 3, '计划任务', json_object("module", 'Schedules', "file", 'Platform.dll', "autoLoad", false, "iconUrl", "icons/schedul.png"), '系统', '00000000000000000000000000000000', now()),
('b4eb74e5df4611e9b5650242ac110002', '8c95d6e097f340d6a8d93a3b5631ba39', '9dd99dd9e6df467a8207d05ea5581125', 2, 4, '消息场景', json_object("module", 'Scenes', "file", 'Platform.dll', "autoLoad", false, "iconUrl", "icons/scene.png"), '系统', '00000000000000000000000000000000', now()),
('33a6d46b337211eaa03a0242ac110004', NULL, '9dd99dd9e6df467a8207d05ea5581125', 1, 3, '基础数据', json_object("iconUrl", "icons/basedata.png"), '系统', '00000000000000000000000000000000', now()),
('a65a562582bb489ea729bb0838bbeff8', '33a6d46b337211eaa03a0242ac110004', '9dd99dd9e6df467a8207d05ea5581125', 2, 1, '应用管理', json_object("module", 'Apps', "file", 'Data.dll', "autoLoad", false, "iconUrl", "icons/resource.png"), '系统', '00000000000000000000000000000000', now()),
('d6254874cd2611e9bbd40242ac110008', '33a6d46b337211eaa03a0242ac110004', '9dd99dd9e6df467a8207d05ea5581125', 2, 2, '接口管理', json_object("module", 'Interfaces', "file", 'Data.dll', "autoLoad", false, "iconUrl", "icons/interface.png"), '系统', '00000000000000000000000000000000', now()),
...
('31baf963337311eaa03a0242ac110004', '2920d9ed337211eaa03a0242ac110004', 'e46c0d4f85f24f759ad4d86b9505b1d4', 2, 2, '模板设计', json_object("module", 'Templates', "file", 'Report.dll', "autoLoad", false, "iconUrl", "icons/design.png"), '系统', '00000000000000000000000000000000', now()),
('31bafa63337311eaa03a0242ac110004', '2920d9ed337211eaa03a0242ac110004', 'e46c0d4f85f24f759ad4d86b9505b1d4', 2, 3, '消息场景', json_object("module", 'Scenes', "file", 'Data.dll', "autoLoad", false, "iconUrl", "icons/scene.png"), '系统', '00000000000000000000000000000000', now()),
...
('cdf0ffb178b741b287d1f155d0165112', '4b3ac9336dd8496597e603fc7e8f5140', 'e46c0d4f85f24f759ad4d86b9505b1d4', 2, 1, '用户', json_object("module", 'Users', "file", 'Base.dll', "autoLoad", true, "iconUrl", "icons/user.png"), '系统', '00000000000000000000000000000000', now()),
...
(replace(uuid(), '-', ''), 'b4eb74e5df4611e9b5650242ac110002', 0, 1, '刷新', 'getScene', json_object("method", "refresh", "iconUrl", "icons/refresh.png", "beginGroup", true, "hideText", true), '系统', '00000000000000000000000000000000', now()),
...
(replace(uuid(), '-', ''), 'b4eb74e5df4611e9b5650242ac110002', 1, 5, '新增配置', 'newSceneConfig,getApp', json_object("method", "newConfig", "iconUrl", "icons/newValue.png", "beginGroup", true, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), 'b4eb74e5df4611e9b5650242ac110002', 1, 6, '编辑', 'editSceneConfig,getApp', json_object("method", "editConfig", "iconUrl", "icons/edit.png", "beginGroup", false, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), 'b4eb74e5df4611e9b5650242ac110002', 1, 7, '删除', 'deleteSceneConfig', json_object("method", "deleteConfig", "iconUrl", "icons/delete.png", "beginGroup", false, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), 'b4eb74e5df4611e9b5650242ac110002', 0, 8, '查看日志', 'getSceneLog', json_object("method", "log", "iconUrl", "icons/log.png", "beginGroup", true, "hideText", false), '系统', '00000000000000000000000000000000', now()),
...
(replace(uuid(), '-', ''), '60dfc370337311eaa03a0242ac110004', 0, 2, '新增字典', 'newDict,getApp', json_object("method", "newItem", "iconUrl", "icons/new.png", "beginGroup", true, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '60dfc370337311eaa03a0242ac110004', 1, 3, '编辑字典', 'editDict,getApp', json_object("method", "editItem", "iconUrl", "icons/edit.png", "beginGroup", false, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '60dfc370337311eaa03a0242ac110004', 1, 4, '删除字典', 'deleteDict', json_object("method", "deleteItem", "iconUrl", "icons/delete.png", "beginGroup", false, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '60dfc370337311eaa03a0242ac110004', 0, 5, '新增值', 'newValue', json_object("method", "newValue", "iconUrl", "icons/newValue.png", "beginGroup", true, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '60dfc370337311eaa03a0242ac110004', 1, 6, '编辑值', 'editValue', json_object("method", "editValue", "iconUrl", "icons/edit.png", "beginGroup", false, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '60dfc370337311eaa03a0242ac110004', 1, 7, '删除值', 'deleteValue', json_object("method", "deleteValue", "iconUrl", "icons/delete.png", "beginGroup", false, "hideText", false), '系统', '00000000000000000000000000000000', now()),
...
(replace(uuid(), '-', ''), '31baf8c0337311eaa03a0242ac110004', 0, 2, '新增值', 'newValue', json_object("method", "newValue", "iconUrl", "icons/new.png", "beginGroup", true, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '31baf8c0337311eaa03a0242ac110004', 1, 3, '编辑值', 'editValue', json_object("method", "editValue", "iconUrl", "icons/edit.png", "beginGroup", false, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '31baf8c0337311eaa03a0242ac110004', 1, 4, '删除值', 'deleteValue', json_object("method", "deleteValue", "iconUrl", "icons/delete.png", "beginGroup", false, "hideText", false), '系统', '00000000000000000000000000000000', now()),
...
(replace(uuid(), '-', ''), '31baf963337311eaa03a0242ac110004', 0, 1, '刷新', 'getTemplate', json_object("method", "refresh", "iconUrl", "icons/refresh.png", "beginGroup", true, "hideText", true), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '31baf963337311eaa03a0242ac110004', 1, 2, '导入', 'importTemplate', json_object("method", "import", "iconUrl", "icons/import.png", "beginGroup", true, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '31baf963337311eaa03a0242ac110004', 1, 3, '编辑', 'editTemplate', json_object("method", "editItem", "iconUrl", "icons/edit.png", "beginGroup", false, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '31baf963337311eaa03a0242ac110004', 1, 4, '删除', 'deleteTemplate', json_object("method", "deleteItem", "iconUrl", "icons/delete.png", "beginGroup", false, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '31baf963337311eaa03a0242ac110004', 1, 5, '复制', 'copyTemplate', json_object("method", "copy", "iconUrl", "icons/copy.png", "beginGroup", true, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '31baf963337311eaa03a0242ac110004', 1, 6, '设计', 'designTemplate', json_object("method", "design", "iconUrl", "icons/design16.png", "beginGroup", false, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '31baf963337311eaa03a0242ac110004', 1, 7, '禁用', 'disableTemplate', json_object("method", "disable", "iconUrl", "icons/disable.png", "beginGroup", true, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '31baf963337311eaa03a0242ac110004', 1, 8, '启用', 'enableTemplate', json_object("method", "enable", "iconUrl", "icons/enable.png", "beginGroup", true, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '31baf963337311eaa03a0242ac110004', 0, 9, '查看日志', 'getTemplateLog', json_object("method", "log", "iconUrl", "icons/log.png", "beginGroup", true, "hideText", false), '系统', '00000000000000000000000000000000', now()),

(replace(uuid(), '-', ''), '31bafa63337311eaa03a0242ac110004', 0, 1, '刷新', 'getScene', json_object("method", "refresh", "iconUrl", "icons/refresh.png", "beginGroup", true, "hideText", true), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '31bafa63337311eaa03a0242ac110004', 1, 2, '新增配置', 'newSceneConfig,getApp', json_object("method", "newConfig", "iconUrl", "icons/newValue.png", "beginGroup", true, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '31bafa63337311eaa03a0242ac110004', 1, 3, '编辑', 'editSceneConfig,getApp', json_object("method", "editConfig", "iconUrl", "icons/edit.png", "beginGroup", false, "hideText", false), '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '31bafa63337311eaa03a0242ac110004', 1, 4, '删除', 'deleteSceneConfig', json_object("method", "deleteConfig", "iconUrl", "icons/delete.png", "beginGroup", false, "hideText", false), '系统', '00000000000000000000000000000000', now()),
...
('9dd99dd9e6df467a8207d05ea5581125', 1, '因赛特多租户平台管理系统', 'MTP', 300, 7200, '系统', '00000000000000000000000000000000', now()),
('e46c0d4f85f24f759ad4d86b9505b1d4', 2, '因赛特用户及权限管理系统', 'RMS', 300, 7200, '系统', '00000000000000000000000000000000', now());
...
(replace(uuid(), '-', ''), NULL, '9dd99dd9e6df467a8207d05ea5581125', '平台管理员', '内置平台管理员角色', 0, '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), NULL, 'e46c0d4f85f24f759ad4d86b9505b1d4', '系统管理员', '租户系统管理员角色模板', 1, '系统', '00000000000000000000000000000000', now());
